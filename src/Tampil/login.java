...
public class login extends javax.swing.JFrame {
     ...
     */
     private Connection conn = new Koneksi().connect(); //variabel mengambil koneksi di package koneksi
    private Object stat;
    ...
    private void initComponents() {
        ...
        jColorChooser1.setForeground(new java.awt.Color(51, 255, 51));
        ...
        lblLogin.setBackground(new java.awt.Color(102, 204, 0));
        lblLogin.setFont(new java.awt.Font("Yu Gothic UI Semilight", 1, 24)); // NOI18N
        lblLogin.setText("LOGIN");

        lblUsername.setFont(new java.awt.Font("Sylfaen", 2, 14)); // NOI18N
        lblUsername.setText("USERNAME");

        lblPassword.setFont(new java.awt.Font("Sylfaen", 2, 14)); // NOI18N
    ...
    private void btnSignInMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSignInMouseClicked
        ...
        try {
            ...
            if (hasil.next()) {
                if (txtUsername.getText().equals(hasil.getString("Username")) && txtPassword.getText().equals(hasil.getString("password"))) {
